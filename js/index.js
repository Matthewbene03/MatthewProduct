...
let inputLogin = document.getElementById("login"); //Recebe o elemento input para o Login
let inputSenha = document.getElementById("senha"); //Recebe o elemento input para a Senha
let buttonEntrar = document.getElementById("BtnEntrar"); //Recebe o elemento button para fazer a autenticação.
let imgIconeVisibilityOff = document.getElementById("iconeVisibilityOff"); //Recebe o elemento icone (iconeVisibilityOff) para fazer a autenticação.
let imgIconeVisibilityOn = document.getElementById("iconeVisibilityOn"); //Recebe o elemento icone (iconeVisibilityOn) para fazer a autenticação.
